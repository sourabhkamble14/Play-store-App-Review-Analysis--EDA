# Capstone_Project : Play Store App Review Analysis
![image](https://user-images.githubusercontent.com/125110357/236635173-3b2b7380-a248-4bc6-9e6f-37fda7161524.png)



## Problem Statement
1. What are the top categories on Google Playstore ?
2. Which category App's have most number of installs ?
3. What is the percentage of Review Sentiments ?
4. Which category of Apps from the Content Rating column are found more on playstore ?
5. What portion of the apps in playstore are paid and free?
6. What are the top 10 most reviewed App on Play Store app?
7. Histogram of Subjectivity
8. Do price of the app effects the rating?
9. What is relationship between Ratings and Reviews. Does more number of reviews means more ratings?
10. What is the distribution of type of reviews in the dataset?
11. What is the percentage of review sentiments?
12. Which are the top 10 expensive Apps in playstore?
14. Distribution of the ratings of the apps?
...
## Dataset
https://drive.google.com/drive/folders/1MV47w0fAsiEKH-1e5fv2rsD20vQBM_pA
## Steps Involved
